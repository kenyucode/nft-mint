async function init() {
    if (window.ethereum == null) {
        ...
        contract = new ethers.Contract("0x504bf7e5cb03ae480d5b20bce7501d1e5d146302", abi, provider);
        ...
        network = await provider.getNetwork();
        contract = new ethers.Contract("0x504bf7e5cb03ae480d5b20bce7501d1e5d146302", abi, signer);
        console.log("selected provider: ", provider);
        console.log("network:", network);
